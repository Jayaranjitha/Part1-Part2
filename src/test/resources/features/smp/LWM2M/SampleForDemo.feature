...
Scenario: MB_Sanity_DM_Upgrade-Creating Test sets 
...
Scenario: MB_Sanity_DM_Upgrade-010-LWM2M_GENERIC_UAT_MISC 
...
Scenario: MB_Sanity_DM_Upgrade-011: VZW-Chapter04Cases > ReadAndWriteDeviceNodes_4_13 - 4.13 Battery Level
